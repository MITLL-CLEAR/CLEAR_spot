...
class ImageGenerator():
    ...
    def generateImage(self):
        ...
        self.image = crop_image(opencv_image, self.TOP_CUT_OFF, self.BOTTOM_CUT_OFF)
...
def startRenderer(imgCli):
    imageGen = ImageGenerator(imgCli) 

    renderThread = threading.Thread(target=imageGen.stitch, daemon=True)
    renderThread.start()
    return imageGen
